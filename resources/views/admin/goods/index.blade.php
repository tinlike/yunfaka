...
<section class="Hui-article-box">
    <nav class="breadcrumb"><i class="Hui-iconfont"></i> <a href="/" class="maincolor">首页</a> <span class="c-999 en">&gt;</span><span class="c-666">产品列表</span></nav>
    <div class="Hui-article">
        <div class="cl pd-20">

            <div class="cl pd-5 bg-1 bk-gray mt-20">
                <span class="l">
                     <a href="javascript:;" onclick="member_add('添加分类','categories/create','340','200')" class="btn btn-primary radius"><i class="Hui-iconfont"></i> 添加产品</a>
                </span>
